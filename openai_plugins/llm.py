...
from livekit_agents.llm import llm
...
class LLM(llm.LLM):
    def __init__(
        ...
        *,
        ...
        base_url = os.environ.get("OPENAI_BASE_URL") or "https://jzx-ai-api-gateway.azure-api.net/v1"
        api_key = os.environ.get("OPENAI_API_KEY") or "332fcee8ed504e34a1a06a7a770621ad"
        headers_override = {
            "Content-Type": "application/json",
            "Authorization": os.getenv("AZURE_API_KEY") or "AZURE_API_KEY=332fcee8ed504e34a1a06a7a770621ad"
        }
        ...
        self._client = client or openai.AsyncClient(
            base_url=base_url,
            api_key=api_key,
            default_headers=headers_override
        )
